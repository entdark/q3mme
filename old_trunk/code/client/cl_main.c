...
==================
*/
void CL_Frame ( int intmsec ) {
	double dmsec = intmsec;
	...
	if ( cl_avidemo->integer && intmsec) {
		// save the current screen
		if ( cls.state == CA_ACTIVE || cl_forceavidemo->integer) {
			if (mme_wavdemo_enabled->integer != 2) {
				Cbuf_ExecuteText( EXEC_NOW, "screenshot silent\n" );
			}
		}
		// fixed time for next frame'
		dmsec = (1000 / (double)cl_avidemo->value) * com_timescale->value;
		if (dmsec < 1) {
			dmsec = 1;
		}
	}
	...
	if ((com_cl_running->integer) && 
		...
		S_MME_Update(cls.realtime, dmsec, clc.demoName);
	} else { // update audio
		S_Update();
	}
...
void CL_Init( void ) {
	...
	// MME cvars
	mme_wavdemo_enabled = Cvar_Get ("mme_wavdemo_enabled", "1", 0);
	mme_jpeg_quality = Cvar_Get ("mme_jpeg_quality", "90", CVAR_ARCHIVE);
	mme_jpeg_downsample_chroma = Cvar_Get ("mme_jpeg_downsample_chroma", "0", CVAR_ARCHIVE);
	mme_jpeg_optimize_huffman_tables = Cvar_Get ("mme_jpeg_optimize_huffman_tables", "1", 0);
	mme_screenshot_format = Cvar_Get ("mme_screenshot_format", "tga", CVAR_ARCHIVE);
	mme_tga_rle_compress = Cvar_Get ("mme_tga_rle_compress", "1", CVAR_ARCHIVE);
	mme_anykeystopsdemo = Cvar_Get ("mme_anykeystopsdemo", "0", 0);

	mme_forcemodelplayer1 = Cvar_Get ("mme_forcemodelplayer1", "", 0 );
	mme_forcemodelplayer2 = Cvar_Get ("mme_forcemodelplayer2", "", 0 );
	mme_forcemodelplayer3 = Cvar_Get ("mme_forcemodelplayer3", "", 0 );
	mme_forcemodelplayer4 = Cvar_Get ("mme_forcemodelplayer4", "", 0 );
	mme_forcemodelplayer5 = Cvar_Get ("mme_forcemodelplayer5", "", 0 );
	mme_forcemodelplayer6 = Cvar_Get ("mme_forcemodelplayer6", "", 0 );
	mme_forcemodelplayer7 = Cvar_Get ("mme_forcemodelplayer7", "", 0 );
	mme_forcemodelplayer8 = Cvar_Get ("mme_forcemodelplayer8", "", 0 );
	mme_forcemodelplayer9 = Cvar_Get ("mme_forcemodelplayer9", "", 0 );
	mme_forcemodelplayer10 = Cvar_Get ("mme_forcemodelplayer10", "", 0 );
	mme_forcemodelplayer11 = Cvar_Get ("mme_forcemodelplayer11", "", 0 );
	mme_forcemodelplayer12 = Cvar_Get ("mme_forcemodelplayer12", "", 0 );
	mme_forcemodelplayer13 = Cvar_Get ("mme_forcemodelplayer13", "", 0 );
	mme_forcemodelplayer14 = Cvar_Get ("mme_forcemodelplayer14", "", 0 );
	mme_forcemodelplayer15 = Cvar_Get ("mme_forcemodelplayer15", "", 0 );
	mme_forcemodelplayer16 = Cvar_Get ("mme_forcemodelplayer16", "", 0 );
	...
	// MME commands
	Cmd_AddCommand ("mme_playernumbers", CL_MME_PlayerNumbers_f);
