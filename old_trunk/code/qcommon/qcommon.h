...
// MME: need common variable names
extern	cvar_t	*mme_screenshot_format;
extern	cvar_t	*mme_jpeg_quality;
extern	cvar_t	*mme_jpeg_downsample_chroma;
extern	cvar_t	*mme_jpeg_optimize_huffman_tables;
extern	cvar_t	*mme_tga_rle_compress;
