...
void S_LoopingSound( const void *parent, const vec3_t origin, const vec3_t velocity, sfxHandle_t sfx, int volume );

// recompute the relative volumes for all running sounds
// relative to the given entityNum / orientation
void S_Respatialize( int entityNum, const vec3_t origin, vec3_t axis[3], int inwater );
void S_MME_Respatialize( int entityNum, const vec3_t origin, const vec3_t velocity, const vec3_t axis[3], float timeScale );
