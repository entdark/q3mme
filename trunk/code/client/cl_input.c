...
void IN_LaggingDown( void ) {
	in_lagging = qtrue;
}

void IN_LaggingUp( void ) {
	in_lagging = qfalse;
}
...
void CL_KeyMove( usercmd_t *cmd ) {
	...
	if ( CL_KeyState (&in_moveright)) 
		side = movespeed;
	else if ( CL_KeyState (&in_moveleft)) 
		side = -movespeed;
...
void CL_InitInput( void ) {
	...
	Cmd_AddCommand ("+lagging", IN_LaggingDown);
	Cmd_AddCommand ("-lagging", IN_LaggingUp);
