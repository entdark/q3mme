...
void SCR_DrawDemoRecording( void ) {
	...
	sprintf( string, "RECORDING %s: %ik", mme_demoFileName->string, pos / 1024 );

	SCR_DrawStringExt( 320 - strlen( string ) * 4, 20, 8, string, colorWhite, qtrue );
}
