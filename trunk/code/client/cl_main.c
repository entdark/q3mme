...
void CL_Record_f( void ) {
	char		demoName[MAX_OSPATH];	// compiler bug workaround
...
void CL_Shutdown( void ) {
	...
	//Remove MME Commands
	Cmd_RemoveCommand ("cslist");
	Cmd_RemoveCommand ("mmeDemo");
	Cmd_RemoveCommand ("demoList");
	Cmd_RemoveCommand ("demoListNext");
