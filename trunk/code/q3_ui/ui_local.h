...
#define QMF_DOUBLECLICK			0x00200000	// respond to double click
...
// ui_credits.c
//
extern void UI_CreditMenu( qboolean quit );
...
void UI_RenderPlayer( const vec3_t origin, playerInfo_t *pi );
