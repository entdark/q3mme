...
#define ID_SOUND			12
#define ID_EFFECTSVOLUME	13
#define ID_MUSICVOLUME		14
#define ID_QUALITY			15
#define ID_TIMESCALE		16
#define ID_BACK				18
...
static void UI_SoundOptionsMenu_Init( void ) {
	...
	y += BIGCHAR_HEIGHT+2;
	soundOptionsInfo.timescale.generic.type			= MTYPE_RADIOBUTTON;
	soundOptionsInfo.timescale.generic.name			= "Timescale:";
	soundOptionsInfo.timescale.generic.flags		= QMF_PULSEIFFOCUS|QMF_SMALLFONT;
	soundOptionsInfo.timescale.generic.callback		= UI_SoundOptionsMenu_Event;
	soundOptionsInfo.timescale.generic.id			= ID_TIMESCALE;
	soundOptionsInfo.timescale.generic.x			= 400;
	soundOptionsInfo.timescale.generic.y			= y;
	...
	Menu_AddItem( &soundOptionsInfo.menu, ( void * ) &soundOptionsInfo.timescale );
	...
	soundOptionsInfo.timescale.curvalue = (int)trap_Cvar_VariableValue( "s_timescale" );
};
