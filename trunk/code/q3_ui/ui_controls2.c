...
typedef struct
{
	...
	menuaction_s		editPrev;
	menuaction_s		editNext;
	menuaction_s		editLock;
	menuaction_s		editAdd;
	menuaction_s		editDelete;
	menuaction_s		editStart;
	menuaction_s		editEnd;
	menuaction_s		editCamera;
	menuaction_s		editChase;
	menuaction_s		editLine;

	menuaction_s		pause;
	menuaction_s		viewNext;
	menuaction_s		viewPrev;
