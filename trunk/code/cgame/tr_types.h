...
#define DECAL_ALPHA			0x001	// Fade the alpha instead of rgb
#define DECAL_ENERGY		0x002   // Fade rgb in beginning followed by an alpha fade
#define DECAL_TEMP			0x004	// Temporary decal, lives only 1 frame
