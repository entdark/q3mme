...
extern void (APIENTRYP qglRenderbufferStorageMultisampleEXT ) ( GLenum target, GLsizei samples, GLenum internalformat, GLsizei width , GLsizei height );
extern void (APIENTRYP qglBlitFramebufferEXT )( GLint srcX0, GLint srcY0, GLint srcX1, GLint srcY1, GLint dstX0, GLint dstY0, GLint dstX1, GLint dstY1, GLbitfield mask, GLenum filter );
...
extern  void ( APIENTRY * qglCallLists )(GLsizei n, GLenum type, const void *lists);
...
extern  void ( APIENTRY * qglDrawPixels )(GLsizei width, GLsizei height, GLenum format, GLenum type, const void *pixels);
extern  void ( APIENTRY * qglEdgeFlag )(GLboolean flag);
extern  void ( APIENTRY * qglEdgeFlagPointer )(GLsizei stride, const void *pointer);
...
extern  void ( APIENTRY * qglGetTexImage )(GLenum target, GLint level, GLenum format, GLenum type, void *pixels);
...
extern  void ( APIENTRY * qglIndexPointer )(GLenum type, GLsizei stride, const void *pointer);
...
extern  void ( APIENTRY * qglInterleavedArrays )(GLenum format, GLsizei stride, const void *pointer);
...
extern  void ( APIENTRY * qglNormalPointer )(GLenum type, GLsizei stride, const void *pointer);
...
extern  void ( APIENTRY * qglTexImage1D )(GLenum target, GLint level, GLint internalformat, GLsizei width, GLint border, GLenum format, GLenum type, const void *pixels);
...
extern  void ( APIENTRY * qglTexSubImage1D )(GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const void *pixels);
...
extern HPBUFFERARB ( WINAPI * qwglCreatePbufferARB) (HDC, int, int, int, const int *);
...
extern BOOL        ( WINAPI * qwglQueryPbufferARB) (HPBUFFERARB, int, int *);
...
extern BOOL        ( WINAPI * qwglSetPbufferAttribARB) (HPBUFFERARB, const int *);
extern BOOL        ( WINAPI * qwglMakeContextCurrentARB) (HDC, HDC, HGLRC);
