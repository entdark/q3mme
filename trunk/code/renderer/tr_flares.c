...
void RB_RenderFlare( flare_t *f ) {
	float			size;
	vec3_t			color;
	vecSimd_t		*xyz = tess.xyz + tess.numVertexes;
	vec2_t			*texCoords = tess.texCoords + tess.numVertexes;
	color4ub_t		*colors = tess.colors + tess.numVertexes;
	color4ub_t		uColor;
...
// Calculations for fogging
	...
	uColor[0] = color[0] * fogFactors[0];
	uColor[1] = color[1] * fogFactors[1];
	uColor[2] = color[2] * fogFactors[2];
	uColor[3] = 255;
	...
	xyz[0][1] = f->windowY - size;
	xyz[1][0] = f->windowX - size;
	xyz[1][1] = f->windowY + size;
	xyz[2][0] = f->windowX + size;
	xyz[2][1] = f->windowY + size;
	xyz[3][0] = f->windowX + size;
	xyz[3][1] = f->windowY - size;
	...
	Byte4Copy( uColor, colors[0] );
	Byte4Copy( uColor, colors[1] );
	Byte4Copy( uColor, colors[2] );
	Byte4Copy( uColor, colors[3] );
