...
/* Pbuffer ARB extensions */
HPBUFFERARB ( WINAPI * qwglCreatePbufferARB) (HDC, int, int, int, const int *);
HDC         ( WINAPI * qwglGetPbufferDCARB) (HPBUFFERARB);
int         ( WINAPI * qwglReleasePbufferDCARB) (HPBUFFERARB, HDC);
BOOL        ( WINAPI * qwglDestroyPbufferARB) (HPBUFFERARB);
BOOL        ( WINAPI * qwglQueryPbufferARB) (HPBUFFERARB, int, int *);

BOOL        ( WINAPI * qwglGetPixelFormatAttribivARB) (HDC, int, int, UINT, const int *, int *);
BOOL        ( WINAPI * qwglGetPixelFormatAttribfvARB) (HDC, int, int, UINT, const int *, FLOAT *);
BOOL        ( WINAPI * qwglChoosePixelFormatARB) (HDC, const int *, const FLOAT *, UINT, int *, UINT *);

BOOL        ( WINAPI * qwglBindTexImageARB) (HPBUFFERARB, int);
BOOL        ( WINAPI * qwglReleaseTexImageARB) (HPBUFFERARB, int);
BOOL        ( WINAPI * qwglSetPbufferAttribARB) (HPBUFFERARB, const int *);
BOOL        ( WINAPI * qwglMakeContextCurrentARB) (HDC, HDC, HGLRC);
...
void (APIENTRYP qglRenderbufferStorageMultisampleEXT ) ( GLenum target, GLsizei samples, GLenum internalformat, GLsizei width , GLsizei height );
