...
#define Q3_VERSION_NUMBER "1.6.11"
#if defined(_DEBUG)
	#define Q3_VERSION_CONSOLE "(debug)Q3MME " Q3_VERSION_NUMBER
#else
	#define Q3_VERSION_CONSOLE "Q3MME " Q3_VERSION_NUMBER
#endif
#define	Q3_VERSION		"Q3 " Q3_VERSION_NUMBER "-MME"
...
#define Byte4Copy(a,b)			*(int *)&(b) = *(int *)&(a) 
#if	1
...
void VectorRotateDirect( vec3_t v, const vec3_t matrix[3] );
